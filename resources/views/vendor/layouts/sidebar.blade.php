            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu" id="menu_dropdown">
                        <li>
                            <a href="{{url('vendor/pmdk')}}" class="accordion-heading"><span class=""><i
                                        class="fa fa-table"></i>PMDK</span></a>
                        </li>
                        <li>
                            <a href="{{url('vendor/usm1')}}" class="accordion-heading"><span class=""><i
                                        class="fa fa-table"></i>USM 1</span></a>
                        </li>
                        <li>
                            <a href="{{url('vendor/usm2')}}" class="accordion-heading"><span class=""><i
                                        class="fa fa-table"></i>USM 2</span></a>
                        </li>
                        <li>
                            <a href="{{url('vendor/usm3')}}" class="accordion-heading"><span class=""><i
                                        class="fa fa-table"></i>USM 3</span></a>
                        </li>
                        <li>
                            <a href="{{url('vendor/utbk')}}" class="accordion-heading"><span class=""><i
    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand text-center" href="{{url('vendor/dashboard')}}"><img style="width: 19%;"
                        src="{{asset('admin/images/logo.png')}}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="{{url('vendor/dashboard')}}"><img
